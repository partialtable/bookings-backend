...
const timesByDateDataGen = (start, end) => {
  ...
  for (var i = start; i <= end; i++) {
    ...
    // check the status
    if ( i === 50 || i === 1000 || i === 5000 || i === 10000 || i === 20000 || i === 50000 || i === 75000 || i === 100000 || i === 150000 || i === 200000 || i === 300000 || i === 400000 || i === 500000 || i === 650000 || i === 850000) {
...
const timesByDate = timesByDateDataGen(1, 1000000);
